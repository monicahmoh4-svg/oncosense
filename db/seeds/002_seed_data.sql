-- OncoSense seed — all 47 Kenya counties
-- Uses DELETE + INSERT so always produces clean data
...
('Kenyatta National Hospital','hospital','Hospital Rd, Upper Hill','Kenya','Nairobi','Nairobi Central',-1.3006,36.8076,'+254202726300',ARRAY['cervical_screening','mammography','oncology','pathology','chemotherapy','radiotherapy','surgery'],ARRAY['SHA','NHIF','AAR','Jubilee','CIC','Britam','Resolution'],'high','public'),
('Nairobi Hospital','hospital','Argwings Kodhek Rd, Nairobi','Kenya','Nairobi','Hurlingham',-1.2979,36.8132,'+254203845000',ARRAY['cervical_screening','mammography','oncology','pathology','mri','chemotherapy','surgery'],ARRAY['SHA','NHIF','AAR','Jubilee','CIC','Britam','Resolution','UAP','Madison'],'high','private'),
('Aga Khan University Hospital','hospital','3rd Parklands Ave, Nairobi','Kenya','Nairobi','Parklands',-1.2618,36.8177,'+254203662000',ARRAY['cervical_screening','mammography','oncology','chemotherapy','radiotherapy','pathology','surgery'],ARRAY['SHA','NHIF','AAR','Jubilee','CIC','Britam','Resolution','UAP','Madison'],'high','private'),
('Karen Hospital','hospital','Karen Rd, Nairobi','Kenya','Nairobi','Karen',-1.3166,36.7173,'+254709876000',ARRAY['cervical_screening','mammography','oncology','pathology','surgery','chemotherapy'],ARRAY['SHA','NHIF','AAR','Jubilee','CIC','Britam','UAP'],'high','private'),
('MP Shah Hospital','hospital','Shivachi Rd, Parklands','Kenya','Nairobi','Parklands',-1.2605,36.8206,'+254203748000',ARRAY['cervical_screening','mammography','oncology','pathology','surgery'],ARRAY['SHA','NHIF','AAR','Jubilee','CIC','Britam'],'high','private'),
('Mbagathi County Hospital','hospital','Mbagathi Way, Nairobi','Kenya','Nairobi','Langata',-1.3167,36.7833,'+254202002555',ARRAY['cervical_screening','via_screening','basic_cancer_screening'],ARRAY['SHA','NHIF'],'medium','public'),
...
('Mama Lucy Kibaki Hospital','hospital','Outer Ring Rd, Nairobi','Kenya','Nairobi','Embakasi',-1.2797,36.8936,'+254202611711',ARRAY['cervical_screening','basic_cancer_screening','surgery'],ARRAY['SHA','NHIF'],'medium','public'),
...
('Aga Khan Hospital Mombasa','hospital','Vanga Rd, Mombasa','Kenya','Mombasa','Mombasa Island',-4.0621,39.6641,'+254412227710',ARRAY['cervical_screening','mammography','oncology','pathology','surgery'],ARRAY['SHA','NHIF','AAR','Jubilee','CIC','Britam','Resolution'],'high','private'),
('Port Reitz Sub County Hospital','hospital','Port Reitz, Mombasa','Kenya','Mombasa','Changamwe',-4.0228,39.5936,'+254412229000',ARRAY['cervical_screening','via_screening'],ARRAY['SHA','NHIF'],'medium','public'),
('Pandya Memorial Hospital','hospital','Dedan Kimathi Ave, Mombasa','Kenya','Mombasa','Mombasa Island',-4.0600,39.6650,'+254412230084',ARRAY['cervical_screening','mammography','surgery','oncology'],ARRAY['SHA','NHIF','AAR','Jubilee','CIC'],'high','private'),
('Likoni Sub County Hospital','hospital','Likoni, Mombasa','Kenya','Mombasa','Likoni',-4.0825,39.6648,'+254412450000',ARRAY['cervical_screening'],ARRAY['SHA','NHIF'],'low','public'),
('Jaramogi Oginga Odinga Teaching Hospital','hospital','Kakamega Rd, Kisumu','Kenya','Kisumu','Kisumu Central',-0.1022,34.7617,'+254572022777',ARRAY['cervical_screening','mammography','oncology','pathology','chemotherapy','surgery'],ARRAY['SHA','NHIF','AAR','Jubilee','CIC'],'high','public'),
('Aga Khan Hospital Kisumu','hospital','Otieno Oyoo St, Kisumu','Kenya','Kisumu','Kisumu Central',-0.0956,34.7603,'+254572026401',ARRAY['cervical_screening','mammography','oncology','surgery'],ARRAY['SHA','NHIF','AAR','Jubilee','CIC','Britam'],'high','private'),
...
('Kisumu Specialist Hospital','hospital','Oginga Odinga St, Kisumu','Kenya','Kisumu','Kisumu Central',-0.1028,34.7523,'+254572020100',ARRAY['cervical_screening','mammography','oncology'],ARRAY['SHA','NHIF','AAR','Jubilee'],'high','private'),
...
('Naivasha County Referral Hospital','hospital','Naivasha Rd, Naivasha','Kenya','Nakuru','Naivasha',-0.7168,36.4328,'+254505020100',ARRAY['cervical_screening','via_screening'],ARRAY['SHA','NHIF'],'medium','public'),
('Nakuru Specialist Hospital','hospital','Clinic Rd, Nakuru','Kenya','Nakuru','Nakuru Town',-0.2833,36.0667,'+254512212000',ARRAY['cervical_screening','mammography','oncology','surgery'],ARRAY['SHA','NHIF','AAR','Jubilee','CIC'],'high','private'),
('Gilgil Sub County Hospital','hospital','Gilgil Town','Kenya','Nakuru','Gilgil',-0.5067,36.3183,'+254510020200',ARRAY['cervical_screening'],ARRAY['SHA','NHIF'],'low','public'),
...
('Tigoni Level 4 Hospital','hospital','Tigoni, Limuru','Kenya','Kiambu','Tigoni',-1.0667,36.7167,'+254722100000',ARRAY['cervical_screening'],ARRAY['SHA','NHIF'],'medium','public'),
('Ruiru Level 4 Hospital','hospital','Ruiru Town','Kenya','Kiambu','Ruiru',-1.1432,36.9610,'+254722200000',ARRAY['cervical_screening'],ARRAY['SHA','NHIF'],'medium','public'),
('Machakos Level 5 Hospital','hospital','Nairobi Rd, Machakos','Kenya','Machakos','Machakos Town',-1.5177,37.2634,'+254452021222',ARRAY['cervical_screening','mammography','oncology','pathology','surgery'],ARRAY['SHA','NHIF','AAR','Jubilee'],'high','public'),
('Kangundo County Referral Hospital','hospital','Kangundo Town','Kenya','Machakos','Kangundo',-1.4032,37.3488,'+254720400000',ARRAY['cervical_screening'],ARRAY['SHA','NHIF'],'low','public'),
...
('Consolata Hospital Nkubu','hospital','Nkubu, Meru','Kenya','Meru','Imenti South',0.0100,37.6200,'+254642030200',ARRAY['cervical_screening','mammography','surgery','oncology'],ARRAY['SHA','NHIF','AAR','Jubilee'],'high','private'),
('Moi Teaching and Referral Hospital','hospital','Nandi Rd, Eldoret','Kenya','Uasin Gishu','Eldoret',0.5143,35.2698,'+254537773000',ARRAY['cervical_screening','mammography','oncology','pathology','chemotherapy','radiotherapy','surgery'],ARRAY['SHA','NHIF','AAR','Jubilee','CIC','Britam','Resolution'],'high','public'),
('Eldoret Wagon Hospital','hospital','Uganda Rd, Eldoret','Kenya','Uasin Gishu','Eldoret',0.5188,35.2841,'+254534633155',ARRAY['cervical_screening','mammography','oncology','surgery'],ARRAY['SHA','NHIF','AAR','Jubilee','CIC'],'high','private'),
...
('Huruma Hospital Eldoret','hospital','Huruma, Eldoret','Kenya','Uasin Gishu','Eldoret',0.5083,35.2694,'+254537771000',ARRAY['cervical_screening','mammography','surgery','oncology'],ARRAY['SHA','NHIF','AAR','Jubilee'],'high','private'),
...
('St Mary Mission Hospital Mumias','hospital','Mumias Town','Kenya','Kakamega','Mumias West',0.3400,34.4800,'+254563041000',ARRAY['cervical_screening','mammography','surgery'],ARRAY['SHA','NHIF','AAR','Jubilee'],'medium','private'),
('Bungoma County Referral Hospital','hospital','Hospital Rd, Bungoma','Kenya','Bungoma','Bungoma Town',0.5635,34.5606,'+254553020000',ARRAY['cervical_screening','mammography','oncology','surgery'],ARRAY['SHA','NHIF','AAR','Jubilee'],'medium','public'),
...
('Mt Elgon Sub County Hospital','hospital','Kopsiro Town, Mt Elgon','Kenya','Bungoma','Mt Elgon',1.0167,34.6833,'+254720600100',ARRAY['cervical_screening'],ARRAY['SHA','NHIF'],'low','public'),
...
('Kaloleni Sub County Hospital','hospital','Kaloleni Town','Kenya','Kilifi','Kaloleni',-3.8833,39.7833,'+254720700100',ARRAY['cervical_screening'],ARRAY['SHA','NHIF'],'low','public'),
('Kwale County Referral Hospital','hospital','Kwale Town','Kenya','Kwale','Kwale Town',-4.1739,39.4522,'+254409820125',ARRAY['cervical_screening','oncology','surgery'],ARRAY['SHA','NHIF','AAR'],'medium','public'),
...
('Suba Sub County Hospital','hospital','Mbita Point','Kenya','Homa Bay','Suba',-0.4167,34.2000,'+254721300000',ARRAY['cervical_screening'],ARRAY['SHA','NHIF'],'low','public'),
...
('Butula Sub County Hospital','hospital','Butula Town','Kenya','Busia','Butula',0.4000,34.0167,'+254721900100',ARRAY['cervical_screening'],ARRAY['SHA','NHIF'],'low','public'),
...
('Kitale Specialist Hospital','hospital','Kenyatta Rd, Kitale','Kenya','Trans Nzoia','Kitale Town',1.0200,34.9950,'+254543021000',ARRAY['cervical_screening','mammography','surgery'],ARRAY['SHA','NHIF','AAR','Jubilee'],'medium','private'),
...
('Nyeri Specialist Hospital','hospital','Kimathi Way, Nyeri','Kenya','Nyeri','Nyeri Town',-0.4200,36.9480,'+254614021000',ARRAY['cervical_screening','mammography','surgery','oncology'],ARRAY['SHA','NHIF','AAR','Jubilee','CIC'],'high','private'),
