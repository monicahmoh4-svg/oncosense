-- OncoSense seed data — Kenya all 47 counties, public + private hospitals, SHA/NHIF info
...
('Aga Khan University Hospital','hospital','3rd Parklands Ave, Nairobi','Kenya','Nairobi','Parklands',-1.2618,36.8177,'+254203662000',ARRAY['cervical_screening','mammography','oncology','chemotherapy','radiotherapy','pathology','surgery','bone_marrow'],ARRAY['SHA','NHIF','AAR','Jubilee','CIC','Britam','Resolution','UAP','Madison','Sanlam'],'high','private'),
...
('MP Shah Hospital','hospital','Shivachi Rd, Parklands','Kenya','Nairobi','Parklands',-1.2605,36.8206,'+254203748000',ARRAY['cervical_screening','mammography','oncology','pathology','surgery'],ARRAY['SHA','NHIF','AAR','Jubilee','CIC','Britam','Resolution'],'high','private'),
...
('Mama Lucy Kibaki Hospital','hospital','Outer Ring Rd, Embakasi','Kenya','Nairobi','Embakasi',-1.2797,36.8936,'+254202611711',ARRAY['cervical_screening','basic_cancer_screening','surgery'],ARRAY['SHA','NHIF'],'medium','public'),
...
('Nairobi West Hospital','hospital','Ngong Rd, Nairobi','Kenya','Nairobi','Nairobi West',-1.3198,36.8010,'+254700007000',ARRAY['cervical_screening','mammography','oncology','surgery'],ARRAY['SHA','NHIF','AAR','Jubilee','CIC'],'high','private'),
...
('St Lukes Orthopaedic and Trauma Hospital','hospital','Kisumu-Nairobi Rd, Kisumu','Kenya','Kisumu','Kisumu West',-0.1024,34.7518,'+254572022066',ARRAY['surgery','orthopedics','basic_cancer_screening'],ARRAY['SHA','NHIF','AAR','Jubilee'],'medium','private'),
...
('Matuu Sub County Hospital','hospital','Matuu Town','Kenya','Machakos','Yatta',-1.1726,37.4878,'+254452023000',ARRAY['cervical_screening'],ARRAY['SHA','NHIF'],'low','public'),
('Mwala Sub County Hospital','hospital','Mwala Town','Kenya','Machakos','Mwala',-1.4500,37.3500,'+254720500000',ARRAY['cervical_screening'],ARRAY['SHA','NHIF'],'low','public'),
...
('Mitobo Sub County Hospital','hospital','Mitobo, Buuri','Kenya','Meru','Buuri',0.2000,37.4000,'+254727000002',ARRAY['cervical_screening'],ARRAY['SHA','NHIF'],'low','public'),
...
('Butere Sub County Hospital','hospital','Butere Town','Kenya','Kakamega','Butere',0.2000,34.4833,'+254563050000',ARRAY['cervical_screening'],ARRAY['SHA','NHIF'],'low','public'),
('St Marys Mission Hospital Mumias','hospital','Mumias Town','Kenya','Kakamega','Mumias West',0.3400,34.4800,'+254563041000',ARRAY['cervical_screening','mammography','surgery','oncology'],ARRAY['SHA','NHIF','AAR','Jubilee'],'medium','private'),
...
('Kilifi District Hospital','hospital','Kilifi Town','Kenya','Kilifi','Kilifi Town',-3.6350,39.8450,'+254412522000',ARRAY['cervical_screening','surgery'],ARRAY['SHA','NHIF'],'medium','public'),
...
('Lungalunga Sub County Hospital','hospital','Lungalunga','Kenya','Kwale','Lunga Lunga',-4.5500,39.1167,'+254720800000',ARRAY['cervical_screening'],ARRAY['SHA','NHIF'],'low','public'),
...
('Suneka Sub County Hospital','hospital','Suneka, Bosongo','Kenya','Kisii','Bosongo',-0.7167,34.8167,'+254720900000',ARRAY['cervical_screening'],ARRAY['SHA','NHIF'],'low','public'),
...
('Manga Sub County Hospital','hospital','Manga Town','Kenya','Nyamira','Manga',-0.5000,34.9167,'+254721100000',ARRAY['cervical_screening'],ARRAY['SHA','NHIF'],'low','public'),
...
('Suba Sub County Hospital','hospital','Mbita Point, Suba','Kenya','Homa Bay','Suba',-0.4167,34.2000,'+254721300000',ARRAY['cervical_screening'],ARRAY['SHA','NHIF'],'low','public'),
...
('Kitale Specialist Hospital','hospital','Hospital Rd, Kitale','Kenya','Trans Nzoia','Kitale Town',1.0200,34.9950,'+254543021000',ARRAY['cervical_screening','mammography','surgery'],ARRAY['SHA','NHIF','AAR','Jubilee','CIC'],'medium','private'),
...
('Tetu Sub County Hospital','hospital','Tetu','Kenya','Nyeri','Tetu',-0.5000,36.7667,'+254722900000',ARRAY['cervical_screening'],ARRAY['SHA','NHIF'],'low','public'),
...
('Embu Specialist Hospital','hospital','Hospital Rd, Embu','Kenya','Embu','Embu Town',-0.5350,37.4480,'+254612021000',ARRAY['cervical_screening','mammography','surgery','oncology'],ARRAY['SHA','NHIF','AAR','Jubilee','CIC'],'high','private'),
...
('Sultan Hamud Sub County Hospital','hospital','Sultan Hamud','Kenya','Makueni','Makindu',-2.0500,37.7333,'+254725400000',ARRAY['cervical_screening'],ARRAY['SHA','NHIF'],'low','public'),
...
('Kapkatet Sub County Hospital','hospital','Kapkatet','Kenya','Kericho','Bureti',-0.5833,35.4667,'+254726000000',ARRAY['cervical_screening'],ARRAY['SHA','NHIF'],'low','public'),
