...
-- Uses gen_random_uuid() built into PostgreSQL 13+ — no extensions needed
...
CREATE INDEX IF NOT EXISTS idx_health_profiles_region ON health_profiles(country, region);
...
CREATE INDEX IF NOT EXISTS idx_image_screenings_user ON image_screenings(user_id);
